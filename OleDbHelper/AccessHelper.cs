...
namespace BMS.DbHelper
{
    ...
    {
       private static readonly AccessHelper sh = new AccessHelper();
        ...
        public static object ExecuteScalarByProc(string procName, Dictionary<string, object> paramsDict)
        {
            try
            {
                ...
                OleDbCommand dbCommand = new OleDbCommand(procName, dbConnection);
        ...
        public static object ExecuteScalarByString(string cmdText, Dictionary<string, object> paramsDict)
        {
            ...
            {
                OleDbConnection dbConnection = new OleDbConnection(DBConnectionString);
                OleDbCommand dbCommand = new OleDbCommand(cmdText, dbConnection);
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(sqlTrans, CommandType.StoredProcedure, "PublishOrders", new OleDbParameter("@prodid", 24));
        /// </remarks>
        ...
        public static int ExecuteNonQuery(OleDbTransaction trans, CommandType cmdType, string cmdText, Dictionary<string, object> paramsDict)
        {
            try
            {  
                OleDbCommand cmd = new OleDbCommand(cmdText, trans.Connection, trans);
        ...
        private static int ExecuteNonQuery(string sqlStr, CommandType cmdType, Dictionary<string, object> paramsDict)
        {
            ...
            {
                OleDbConnection dbConnection = new OleDbConnection(DBConnectionString);
                OleDbCommand dbCommand = new OleDbCommand(sqlStr, dbConnection);
                ...
                //dbCommand.Parameters.Add(new OleDbParameter("@return", OleDbType.Int));
